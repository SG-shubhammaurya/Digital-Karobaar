          ...
          children: [
            ...
            Container(
              child: Form(
                ...
                _buildPassword(),
                SizedBox(height: 20,),
                Text("Please provide the Contact details of the main Admin for the Seller profile, which will the main head of the Business and hence would receive OTP for verification."),
                SizedBox(height: 30),
                _buildSellerNo(),
