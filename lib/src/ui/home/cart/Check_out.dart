...
class _CheckOutState extends State<CheckOut> {
                    ...
                    child: Column(
                      children: [
                        ...
                        GestureDetector(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, RouterName.addressDeliver).then((value) {
                                      _getAddress() ;
                                  });
                            },
                            child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('GST Certificate, Shop EstaLicense, UdhyogAadhar,CAcheque, Trade,FSSAI, DrugLicense.',
  ...
  void _handleExternalWallet(ExternalWalletResponse response) {
    _updatePayment("Payment from Wallet");
    //response.
    Fluttertoast.showToast(
        backgroundColor: AppColors.primaryColor,
