        ...
        child: Column(
          children:[
              ...
              (
                ...
                //color: Colors.blue,
                 child: ListView.builder(
                            ...
                            itemBuilder: (c, index){
                              return 
                              Image.network(images[index].vyaparSurakshaImage,fit: BoxFit.cover,);
                            }
                            ),
              ),
            ),
            ...
            Padding(
              ...
              child: Center(
                child: Text(
                  "Join us and become a premiun seller and grow your business more faster",style: TextStyle(fontSize: 20),
                )
                ),
            ),
            SizedBox(height: 50),
            ...
            InkWell(
              ...
              child: Container(
                ...
                width: 200,
                child: Center(
                  child: Text("Become a premium seller")
                ) ,),
              )
          ]
        ),
