...
class OrderShiped extends StatefulWidget {
  @override
  _OrderShipedState createState() => _OrderShipedState();
}
...
class _OrderShipedState extends State<OrderShiped> {
  ...
  _getSellerOrder() async {
    var sellerAllOrderList = await DashRepository.getAllSellerOrderShiped()
    .catchError((e){
      setState(() {
         isLoading = false;
      });
      ...
      ? Center(
        child: CircularProgressIndicator(
          valueColor: AlwaysStoppedAnimation<Color>(AppColors.primaryColor),
                ...
                ? Center(child: NoDataAvailable(message: "No Shipped Available"))
            :
        ListView.builder(
