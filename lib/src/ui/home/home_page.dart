...
// import 'InAppNotification/notification.dart';
            ...
            child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintText:
                     ...
                     LanguageKeys.search.translate(context),
                      ...
                      Container(
                        child: Column(children: [
                          Padding(
                            ...
                            child: Container(
                                child: Text(
                                  LanguageKeys.deliverTo.translate(context),
                                  //"Deliver To:",
                                    style: TextStyle(
                                        color: Colors.blue,
                                        fontWeight: FontWeight.bold))),
        ...
        children: <Widget>[
          ...
          BlocBuilder<ThemeCubit, ThemeState>(
            builder: (context, themeState) => SwitchListTile(
              ...
              value: themeState.themeMode == ThemeMode.dark,
              title: Text(
               LanguageKeys.theme.translate(context)
              ),
            ),
          ),
          InkWell(
          ...
          ListTile(
            ...
            title: InkWell(
                ...
                child: Text(
                  LanguageKeys.language.translate(context)
                  )
                  ),
          ),
          // InkWell(
