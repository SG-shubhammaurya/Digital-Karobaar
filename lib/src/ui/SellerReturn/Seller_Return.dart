...
class SellerReturns extends StatefulWidget {
  @override
  _SellerReturnsState createState() => _SellerReturnsState();
}

class _SellerReturnsState extends State<SellerReturns> {
  ...
  _getSellerReturn() async {
    var sellerReturnList =
        await DashRepository.getSellerReturn().catchError((e) {
      setState(() {
        isLoading = false;
      });
    });
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                    height: 50,
                    width: 250,
                    child: Center(child: Text("Click Return to know more",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),))
                    //color: Colors.white,
                    // child: TextFormField(
