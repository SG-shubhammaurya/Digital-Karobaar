...
class SellerApprovedReturn extends StatefulWidget {
  @override
  _SellerApprovedReturnState createState() => _SellerApprovedReturnState();
}

class _SellerApprovedReturnState extends State<SellerApprovedReturn> {
  ...
  void initState() {
   ...
   _getSellerReturn() async {
    var sellerReturnList =
        await DashRepository.getSellerApprovedReturn().catchError((e) {
      setState(() {
        isLoading = false;
      });
    });
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                    ...
                    width: 250,
                    //color: Colors.white,
                    child: Center(child: Text("Click Approved to know more",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),))
                  ),
                ),
                Text("|"),
                SizedBox(width: 8.0),
